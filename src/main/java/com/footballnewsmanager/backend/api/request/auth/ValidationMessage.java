...
public class ValidationMessage {
    ...
    public static final String LANGUAGE_NOT_BLANK = "Pole język nie może być puste";
    public static final String NOTIFICATION_NOT_BLANK = "Pole powiadomienia nie może być puste";
    public static final String DARK_MODE_NOT_BLANK ="Pole ciemny motyw nie może być puste";
    ...
    public static final String HIGHLIGHTED_NOT_BLANK = "Pole wyróżnienie nie może być wartością pustą";
